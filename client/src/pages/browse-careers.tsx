...
import { ArrowRight, TrendingUp, DollarSign, Activity, Brain, ArrowLeft } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12 space-y-4">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            Discover diverse career opportunities and experience them through immersive AR previews
          </p>
        </div>
