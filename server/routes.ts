...
const careers: Career[] = [
  ...
  },
  {
    ...
    category: "Education",
    image: "https://images.unsplash.com/photo-1631537631780-b01b2b61f06c?w=500&h=300&fit=crop",
  ...
  },
  {
    ...
    description: "Design and develop artificial intelligence and machine learning solutions that solve complex real-world problems.",
    category: "Technology",
    image: "https://images.unsplash.com/photo-1665089460510-cd4628902249?w=500&h=300&fit=crop",
    salaryRange: { min: 1200000, max: 3500000, currency: "INR" },
    growthPotential: 98,
    stressIndex: 72,
    mismatchProbability: 14,
    requiredSkills: ["Machine Learning", "Python", "Deep Learning", "Data Science"],
    personalityTraits: ["Analytical", "Innovative", "Detail-oriented", "Curious"],
    industryTrends: "Explosive demand for AI/ML expertise, integration across all industries, highest growth in tech and finance",
  },
  {
    id: "cloud-architect",
    title: "Cloud Architect",
    description: "Design and manage scalable cloud infrastructure and solutions for enterprise-level applications.",
    category: "Technology",
    image: "https://images.unsplash.com/photo-1677442d019cecf8cdc7a0e3faf7c0f8?w=500&h=300&fit=crop",
    salaryRange: { min: 1400000, max: 4000000, currency: "INR" },
    growthPotential: 96,
    stressIndex: 68,
    mismatchProbability: 16,
    requiredSkills: ["Cloud Platforms", "System Design", "DevOps", "Security"],
    personalityTraits: ["Strategic", "Problem-solver", "Detail-oriented", "Collaborative"],
    industryTrends: "Cloud migration accelerating, multi-cloud strategies becoming standard, high demand for AWS/Azure/GCP expertise",
  },
  {
    id: "product-manager",
  ...
  app.get("/api/careers-realtime", async (req, res) => {
    try {
      ...
      if (realtimeCareers.length > 0) {
        // Merge with local career images and data
        const careersWithImages = realtimeCareers.map(geminiCareer => {
          const localCareer = careers.find(c => c.title === geminiCareer.title);
          return {
            ...geminiCareer,
            image: localCareer?.image,
            workspace3dModel: localCareer?.workspace3dModel,
          };
        });
        res.json(careersWithImages);
      } else {
        res.json(careers);
      }
    } catch (error) {
